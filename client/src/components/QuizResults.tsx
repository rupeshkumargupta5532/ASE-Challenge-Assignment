...
export default function QuizResults({ score, totalQuestions, results, onRestart }: QuizResultsProps) {
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span 
                      className={result.isCorrect ? 'text-success font-medium' : 'text-destructive font-medium'}
